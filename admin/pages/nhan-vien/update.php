...
<div class="main-update">
    ...
    <form class="form-group" action="pages/nhan-vien/action.php?req=update" method="post">
        ...
        <input type="hidden" class="form-control" id="password_old" name="password_old" value="<?= $nhanVien__Get_By_Id->password ?>">
        ...
        <div class="col">
            ...
            <select class="form-select " aria-label=".phanquyen" id="phanquyen" name="phanquyen">
                ...
                <option value="3" <?= $nhanVien__Get_By_Id->phanquyen == 3 ? 'selected' : '' ?>>Khách hàng</option>
            </select>
        </div>
        <br />
